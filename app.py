...
tablename = "investment_institutions"
...
</style></head><body><div class="container"><div class="header"><div><div class="logo">
<span class="sun">🌻</span>
Gastei
</div><div class="subtitle">
Controle financeiro pessoal
</div></div></div><div class="grid"><div class="card highlight"><div class="label">
Patrimônio estimado
</div><div class="value yellow">
__PATRIMONIO__
...
Receitas
</div><div class="value green">
__RECEITAS__
</div></div><div class="card"><div class="label">
Despesas
</div><div class="value red">
__DESPESAS__
</div></div></div><h2>
Adicionar receita
</h2><div class="card"><form
    method="post"
    action="/income"
><input
name="description"
...
<select name="account_id" required>CONTAS
...
Últimas receitas
</h2><div class="card">RECEITAS_RECENTES

</div><h2>
Últimas despesas
</h2><div class="card">DESPESAS_RECENTES
...
"""replacements = {
    ...
    "__RECEITAS__":
        dinheiro(total_receitas),

    "__DESPESAS__":
        dinheiro(total_despesas),
